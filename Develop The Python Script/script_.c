...
void welcome()
{
  lcd.print("WELCOME TO S.W.B ");
  Serial.println("WELCOME TO  S.W.B.");
  lcd.setCursor(0, 1);
  lcd.print(" SMART BIN");
  delay(1000);
}
...
void selection()
{
  ...
  lcd.setCursor(0, 1);
  Serial.println("please select the typeof waste");
